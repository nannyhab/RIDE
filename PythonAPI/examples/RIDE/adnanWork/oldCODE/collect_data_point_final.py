def collect_data_point(client, track_xodr, track_id, gear_ratio, tire_friction):
    ...
    FIXED: Complete measurement before cleanup
    """
    ...
    try:
        ...
        # Measure - RECORD START TIME IMMEDIATELY
        ...
        for step in range(max_steps):
            ...
            try:
                ...
                # Vehicle was destroyed externally
                print("- Vehicle destroyed externally")
                return None, None, False
        ...
        # RECORD END TIME BEFORE ANY CLEANUP
